window.addEventListener("load",function(){
    ...
    var c = document.getElementById('t4');
    c.width = w;
    c.height = h;
    ...
    function loop1(){
        if(f){
            ...
            var color0=[
                ...
                Math.cos(t+Math.PI*1/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*1/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*1/3)/2+0.5,1,
                Math.cos(t+Math.PI*2/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*2/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*2/3)/2+0.5,1,
                Math.cos(t+Math.PI*3/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*3/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*3/3)/2+0.5,1,
                Math.cos(t+Math.PI*4/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*4/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*4/3)/2+0.5,1,
                Math.cos(t+Math.PI*5/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*5/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*5/3)/2+0.5,1,
                Math.cos(t+Math.PI*6/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*6/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*4/3)/2+0.5,1,
                Math.cos(t+Math.PI*7/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*7/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*5/3)/2+0.5,1,
