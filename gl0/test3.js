window.addEventListener("load",function(){
    ...
    function loop0(){
        if(f){
            ...
            m.rotate(mMatrix,t,[0.0,1.0,2.0],mMatrix);
            ...
            var color0=[
                ...
                Math.cos(t+Math.PI*1/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*1/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*1/4)/2+0.5,1,
                Math.cos(t+Math.PI*2/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*2/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*2/4)/2+0.5,1,
                Math.cos(t+Math.PI*3/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*3/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*3/4)/2+0.5,1,
                Math.cos(t+Math.PI*4/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*4/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*4/4)/2+0.5,1,
                Math.cos(t+Math.PI*5/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*5/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*5/4)/2+0.5,1,
                Math.cos(t+Math.PI*6/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*6/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*6/4)/2+0.5,1,
                Math.cos(t+Math.PI*7/4)/2+0.5,Math.cos(Math.PI*t+Math.PI*7/4)/2+0.5,Math.cos(Math.LN2*t+Math.PI*7/4)/2+0.5,1
            ];
            var colVbo0 = gl.createBuffer();
            gl.bindBuffer(gl.ARRAY_BUFFER, colVbo0);
            gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(color0), gl.STATIC_DRAW);
            ...
            gl.bindBuffer(gl.ARRAY_BUFFER, null);
            gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, indexVbo0);
            gl.drawElements(gl.LINES, index0.length, gl.UNSIGNED_SHORT, 0);
